...
const getClassName = getClassNameFactory("Widget", styles);
...
export const Widget: ComponentConfig<WidgetProps> = {
  fields: {
    quote: {
      type: "external",
      ...
      fetchList: async ({ query, filters }) => {
        // Simulate delay
        const quotes = await fetch(`https://dev-2jh2sznfizjkeg1.api.raw-labs.com/your/endpoint/2`).then(
          (res) => res.json()
        );
